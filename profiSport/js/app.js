...
if (document.querySelector(".slider-projects__body")) {
  new Swiper(".slider-projects__body", {
    observer: true,
    observeParents: true,
    slidesPerView: 2.5,
    spaceBetween: 38,
...
//========================================================================================================================================================
if (document.querySelector(".slider-proj__body")) {
  new Swiper(".slider-proj__body", {
    observer: true,
    observeParents: true,
    slidesPerView: 2.5,
    spaceBetween: 38,
...
//========================================================================================================================================================
if (document.querySelector(".slider-pro__body")) {
  new Swiper(".slider-pro__body", {
    observer: true,
    observeParents: true,
    slidesPerView: 2.5,
    spaceBetween: 38,
    ...
    // Dotts
    pagination: {
      el: ".slider-projects__dottss",
      clickable: true,
    },
    // Arrows
    navigation: {
      nextEl: ".slider-arro .slider-arro_next",
      prevEl: ".slider-arro .slider-arro_prev",
    },
    breakpoints: {
      320: {
        slidesPerView: 1.3,
...
if (document.querySelector(".images-product")) {
  ...
  let imagesMainslider = new Swiper(".images-product__mainslider", {
    ...
    // Arrows
    navigation: {
      nextEl: ".images-product .images-arrow_next",
      prevEl: ".images-product .images-arrow_prev",
    },
	 thumbs: {
...
//========================================================================================================================================================
let formMenu = document.querySelector(".form-menu__icon");
if (formMenu != null) {
	let delay = 500;
	let menuForm = document.querySelector(".item-form");
	formMenu.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			formMenu.classList.toggle("_active");
			menuForm.classList.toggle("_active");
		}
	});
	document.addEventListener("click", function (e){
		if(!e.target.classList.contains('form-menu__icon') && !e.target.classList.contains('item-form__input')){
			formMenu.classList.remove("_active");
			menuForm.classList.remove("_active");
		}
	});
}; 
//========================================================================================================================================================
